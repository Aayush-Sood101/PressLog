    ...
    <div className="bg-[#f6f7f8] font-sans text-slate-900 min-h-screen flex flex-col overflow-x-hidden">
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-slate-200 px-6 md:px-10 py-4 bg-white">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/sign-in" className="flex min-w-[84px] cursor-pointer items-center justify-center rounded-lg h-10 px-4 border border-[#1a355b] text-[#1a355b] hover:bg-[#1a355b]/5 transition-colors text-sm font-bold">
            Sign In
          </Link>
        </div>
      </header>
      ...
      <footer className="py-6 px-10 flex justify-center items-center gap-4 text-slate-400 text-xs text-center border-t border-slate-200">
